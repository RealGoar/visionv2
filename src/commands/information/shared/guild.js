...
module.exports = async (guild) => {
  ...
  const embed = new EmbedBuilder()
    ...
    .setAuthor({ name: `${name}\'s Information`})
    //.setAuthor({ name: `${name}\'s Information`, iconURL: `${guild.iconURL({ format: "png", size: 4046 })}`})
    .setThumbnail(guild.iconURL({ format: "png", size: 4046 }))
